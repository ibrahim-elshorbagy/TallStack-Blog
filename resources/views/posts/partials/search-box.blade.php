...
<div class="flex ">
    <div class="flex ">
        <div class="flex items-center px-3 py-2 mb-3 bg-gray-100 rounded-2xl">
            ...
            <input x-model='query'
                class="w-35 ml-1 text-xs text-gray-800 bg-transparent border-none outline-none focus:outline-none focus:border-none focus:ring-0 placeholder:text-gray-400"
